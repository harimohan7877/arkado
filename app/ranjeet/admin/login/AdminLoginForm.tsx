    ...
    <div className="min-h-screen bg-[#0d1117] text-stone-100 flex flex-col justify-between p-4 sm:p-6 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto my-auto relative z-10 bg-stone-900/90 border border-stone-800 backdrop-blur-xl rounded-2xl shadow-2xl p-7 sm:p-9 animate-slide-up">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block relative h-10 w-36 mb-4">
            <Image
              src="/logo.svg"
              alt="Arkado"
              width={150}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-stone-700 bg-stone-950/80 text-white text-sm font-mono tracking-wider focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 transition placeholder:text-stone-600"
                autoFocus
                disabled={loading}
              />
              <button
                ...
                className="absolute right-3 top-3 text-xs font-mono text-stone-400 hover:text-stone-200 transition cursor-pointer px-1 py-0.5"
              >
