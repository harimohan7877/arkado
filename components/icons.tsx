...
export const HeartIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M19 14c1.5-1.5 3-3.4 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.8 0-3 .8-4.5 2.5C10.5 3.8 9.3 3 7.5 3A5.5 5.5 0 0 0 2 8.5c0 2.1 1.5 4 3 5.5l7 7Z" /></svg>
);
...
export const StarIcon = (p: IconProps) => (
  <svg {...base(p)} fill="currentColor" stroke="none"><path d="M12 2 15.1 8.6 22 9.3l-5 4.9 1.2 6.9L12 17.8l-6.2 3.3L7 14.2 2 9.3l6.9-.7Z" /></svg>
);
...
export const MapPinIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M20 10c0 7-8 13-8 13s-8-6-8-13a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
);
...
export const SparklesIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M12 3v3m0 12v3m-9-9h3m12 0h3M5.6 5.6l2.1 2.1m8.6 8.6 2.1 2.1M5.6 18.4l2.1-2.1m8.6-8.6 2.1-2.1" /></svg>
);

export const FlameIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 17c1.4 0 2.5-1.1 2.5-2.5 0-2.5-2.5-3.5-2.5-5.5C11 7 12 5 12 5s3 2 3 6c0 1.7-.6 3-1.5 3.5" /><path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5 0 4-3 5-5 6.5-1.5 1.1-2 2.5-2 4a4 4 0 0 0 4 4Z" /></svg>
);

export const TagIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82Z" /><line x1="7" y1="7" x2="7.01" y2="7" /></svg>
);
...
export const ShoppingBagIcon = (p: IconProps) => (
  <svg {...base(p)}><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z" /><line x1="3" y1="6" x2="21" y2="6" /><path d="M16 10a4 4 0 0 1-8 0" /></svg>
);
...
export const ImageIcon = (p: IconProps) => (
  <svg {...base(p)}><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" /></svg>
);
...
export const CopyIcon = (p: IconProps) => (
  <svg {...base(p)}><rect width="14" height="14" x="8" y="8" rx="2" ry="2" /><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" /></svg>
);
